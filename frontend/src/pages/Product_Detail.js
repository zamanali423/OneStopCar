...
import dummyImg2 from "../assets/images/h1.jpg";
import dummyImg3 from "../assets/images/h11.jpg";
import dummyImg4 from "../assets/images/h4.jpg";
...
const Product_Detail = () => {
  ...
  const { url, items } = useContext(productContext);
  ...
  const validImages = item?.images?.length
    ? item.images
    : [dummyImg, dummyImg2, dummyImg3, dummyImg4];
  ...
  const fetchProductDetails = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `${url}/shop/products/product-details/${encodedTitle}`
      );
  ...
  // Compute related products only when item is fetched
  const relatedProducts = useMemo(() => {
    return items?.filter((product) => product?.category === item?.category);
  }, [items, item]);

  // Render fallback states after hooks
  ...
  return (
      ...
      <div className="block-header block-header--has-breadcrumb">
        <div className="container">
          <div className="block-header__body">
            <Breadcrumb previous="Shop" current="Product Detail" />
          </div>
        </div>
      </div>
            ...
            <div className="block-split__item block-split__item-content col-auto">
              <div className="product product--layout--full">
                <div className="product__body">
                  ...
                  {/* crousel  */}
                  <div className="product-gallery product-gallery--layout--product-full product__gallery">
              ...
              c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"
                      ...
                      <div className="image image--type--product">
                        ...
                        >
                          <div className="image__body carousel-slide">
                            <img
                              className="image__tag carousel-image"
                    ...
                    <div className="carousel-indicators">
                      {validImages.map((img, index) => (
                        <img
                          src={img}
                          alt={`Thumbnail ${index}`}
                          className={`image__tag carousel-thumbnail ${
                  ...
                  <div className="product__main">
                    <div className="product__excerpt">
                      <div class="product__features">
                        <div class="product__features-title">Specifictions:</div>
    ...
    c0.865,1.414,0.61,3.243-0.524,4.383L10.586,4.788C12.12,4.295,13.864,4.903,14.728,6.314L14.728,6.314z M14.728,6.314"
                          ...
                          <div className="shop-features__info">
                            ...
                            <div className="shop-features__item-subtitle">
                              Change Your Mind? We've Got 7 Days to Make It
                              Right!
                            </div>
                          </div>
                        </li>
                    ...
                    <ul className="product-tabs__list">
                      ...
                      <li className="product-tabs__item">
                        <a href="#product-tab-reviews">
                          Reviews
                          <span className="product-tabs__item-counter">3</span>
                        </a>
                      </li>
                    </ul>
