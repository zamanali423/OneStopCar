...
const Mobile_Menu = () => {
  return (
	...
	c-1.5,0-2.9,0.6-4,1.5C8.9,1.6,7.5,1,6,1C2.7,1,0,3.7,0,7c0,5,6,12,10,12s10-7,10-12C20,3.7,17.3,1,14,1L14,1z"
                  ...
                  <span className="mobile-menu__indicator-title">Wishlist</span>
                </a>
                <a className="mobile-menu__indicator" href="account-dashboard.html">
                  <span className="mobile-menu__indicator-icon">
                    <svg width="20" height="20">
                      <path
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"
                ...
                <a className="mobile-menu__indicator" href="account-garage.html">
                  <span className="mobile-menu__indicator-icon">
                    <svg width="20" height="20">
                      <path
	...
	C15.5,10.2,14,11.3,14,12z"
              ...
              <ul className="mobile-menu__links">
                <li data-mobile-menu-item>
                  <a href="index.html" className="" data-mobile-menu-trigger>
                    Home
                    <svg width="7" height="11">
                      <path
                  ...
                  <div className="mobile-menu__links-panel" data-mobile-menu-panel>
                    <div className="mobile-menu__panel mobile-menu__panel--hidden">
                      <div className="mobile-menu__panel-header">
                        ...
                        <div className="mobile-menu__panel-title">Home</div>
                      </div>
                      <div className="mobile-menu__panel-body">
                        <ul className="mobile-menu__links">
                          <li data-mobile-menu-item>
                  ...
                  <div className="mobile-menu__links-panel" data-mobile-menu-panel>
                    <div className="mobile-menu__panel mobile-menu__panel--hidden">
                      <div className="mobile-menu__panel-header">
                        ...
                        <div className="mobile-menu__panel-title">Shop</div>
                      </div>
                      <div className="mobile-menu__panel-body">
                        <ul className="mobile-menu__links">
                          <li data-mobile-menu-item>
                  ...
                  <div className="mobile-menu__links-panel" data-mobile-menu-panel>
                    <div className="mobile-menu__panel mobile-menu__panel--hidden">
                      <div className="mobile-menu__panel-header">
                        ...
                        <div className="mobile-menu__panel-title">Blog</div>
                      </div>
                      <div className="mobile-menu__panel-body">
                        <ul className="mobile-menu__links">
                          <li data-mobile-menu-item>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                  ...
                  <div className="mobile-menu__links-panel" data-mobile-menu-panel>
                    <div className="mobile-menu__panel mobile-menu__panel--hidden">
                      <div className="mobile-menu__panel-header">
                        ...
                        <div className="mobile-menu__panel-title">Account</div>
                      </div>
                      <div className="mobile-menu__panel-body">
                        <ul className="mobile-menu__links">
                          <li data-mobile-menu-item>
                ...
                <li data-mobile-menu-item>
                  <a href="about-us.html" className="" data-mobile-menu-trigger>
                    Pages
                    <svg width="7" height="11">
                      <path
                        d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                  ...
                  <div className="mobile-menu__links-panel" data-mobile-menu-panel>
                    <div className="mobile-menu__panel mobile-menu__panel--hidden">
                      <div className="mobile-menu__panel-header">
                        ...
                        <div className="mobile-menu__panel-title">Pages</div>
                      </div>
                      <div className="mobile-menu__panel-body">
                        <ul className="mobile-menu__links">
                          <li data-mobile-menu-item>
              ...
              <a className="mobile-menu__contacts" href="">
                <div className="mobile-menu__contacts-subtitle">Free call 24/7</div>
