  ...
  return (
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z"
              ...
              <div className="block-features__item-info">
                ...
                <div className="block-features__item-subtitle">
                  Free Shipping, Always – Quality Delivered to Your Doorstep!
                </div>
              </div>
            </li>
            <li className="block-features__item">
    ...
    c0.865,1.414,0.61,3.243-0.524,4.383L10.586,4.788C12.12,4.295,13.864,4.903,14.728,6.314L14.728,6.314z M14.728,6.314"
              ...
              <div className="block-features__item-info">
                ...
                <div className="block-features__item-subtitle">
                  Change Your Mind? We've Got 7 Days to Make It Right!
                </div>
              </div>
            </li>
            <li className="block-features__item">
	...
	S40.1,35.1,40.3,35.1z"
              ...
              <div className="block-features__item-info">
                ...
                <div className="block-features__item-subtitle">
                  18 Months of Worry-Free Use – We've Got You Covered!
                </div>
              </div>
            </li>
            <li className="block-features__item">
	...
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z"
              ...
              <div className="block-features__item-info">
                ...
                <div className="block-features__item-subtitle">
                  Pay When It Arrives – Shop Secure with Cash on Delivery!
                </div>
              </div>
            </li>
          </ul>
